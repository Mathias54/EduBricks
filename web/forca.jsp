<%-- 
    Document   : memo
    Created on : 02/08/2016, 20:13:21
    Author     : Josi Schwarz
--%>
                ...
                <script language="JavaScript">
                    ...
                    function verificaerro() {
                        ...
                        switch (erro) {
                            ...
                            default:
                                 ...
                                 */
                                d = "<img src='imagens/maozinharuim.jpg'><br><br>";
                    ...
                    function jogar(letra) {
                        ...
                        if (coleta == palavras[iconte].toUpperCase()) {
                            ...
                            var winmsg = "<br><img src='imagens/maozinha.jpg'>";
                            ...
                            if (itempodejogo < 30) {
                                stempo.document.write("<center><font style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;font-color:#ffffff;color:#ffffff;font-weight:bold; text-decoration : none;'><b>PARABENS seu tempo foi de (" + itempodejogo + ")seg.<br><img src='imagens/maozinha.jpg'>");
                            } else {
                                if (itempodejogo < 60) {
                                    stempo.document.write("<center><font style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;font-color:#ffffff;color:#ffffff;font-weight:bold; text-decoration : none;'><b>eh vc foi mais ou menos, mas mesmo assim PARABENS seu tempo foi de (" + itempodejogo + ")seg.<br><img src='imagens/maozinha.jpg'>");
                                } else {
                                    stempo.document.write("<center><font style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;font-color:#ffffff;color:#ffffff;font-weight:bold; text-decoration : none;'><b></b>Ateh ganhou, mas es MUITO FRACO.. seu tempo foi de (" + itempodejogo + ")seg.<br><img src='imagens/maozinha.jpg'>");
                                }
                            }
