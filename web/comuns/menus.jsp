...
<!--        <ul id="dropdownMemoria" class="dropdown-content">
        ...
        <ul id="dropdownSom" class="dropdown-content">
            ...
            <li><a href="somInstrumentos.jsp" style="color:#000;" >Instrumento</a></li>
...
<!--        <ul id="dropdownQuebraCabeça" class="dropdown-content">
        ...
        <ul id="dropdownOutros" class="dropdown-content">
            <li><a href="#!" style="color:#000;" >EduBrink App</a></li>
        ...
        <nav class="nav">
            <div class="nav-wrapper">
                ...
                <ul id="nav-mobile" class="right hide-on-med-and-down">
                    ...
                    <li><a class="dropdown-button" href="../recursos/Aplicativo/Edubrink.apk" data-activates="dropdownOutros">Outros Jogos<i class="material-icons right">arrow_drop_down</i></a></li>                 
                <!--<a href="../recursos/Aplicativo/Edubrink.apk">EduBrink App</a>-->
                </ul>
                    ...
                    <li class="no-padding">
                        ...
                        <ul class="collapsible collapsible-accordion">
                            <li class="bold"><a class="collapsible-header  waves-effect waves-teal">Cores</a>
                                <div class="collapsible-body">
                                    <ul>
                                        <li><a href="cores.jsp">Reconhecer cor</a></li>
                                        <li><a href="escrevaCor.jsp">Escrever Nome da cor</a></li>
                                    </ul>
                                </div>
                            </li>
                        </ul>
<!--                        <ul class="collapsible collapsible-accordion">
                        ...
                        <ul class="collapsible collapsible-accordion">
                            <li class="bold"><a class="collapsible-header  waves-effect waves-teal">Som</a>
                                <div class="collapsible-body">
                                    <ul>
                                        <li><a href="somAnimais.jsp">Animais</a></li>
                                        <li><a href="somInstrumentos.jsp">Instrumento</a></li>
...
<!--                        <ul class="collapsible collapsible-accordion">
                        ...
                        <ul class="collapsible collapsible-accordion">
                            <li class="bold"><a class="collapsible-header  waves-effect waves-teal">Outros Jogos</a>
                                <div class="collapsible-body">
                                    <ul>
                                        <a href="../recursos/Aplicativo/Edubrink.apk">EduBrink App</a>
                                        <!--<li><a href="/recursos/Aplicativo/E">EduBink App</a></li>-->
