<%-- 
    Document   : somInstrumentos
    Created on : 29/06/2017, 22:52:34
    Author     : mathias
--%>
...
<html>
    ...
    <body onload="somInstrumentos(); execucaoSomInstrumentos()();">
                        ...
                        <div class="row">
                            <div class="txt-central">
                                <center>
                                    ...
                                    <p  loop='false'  id="paragrafo" onclick="execucaoSomInstrumentos();" style="background-color: white; border-radius: 5px; height: 100px; width: 100px; color: black; font-size: 30px; padding: 10px;">
        ...
        <div id="modal1" class="modal">
            <center>
                ...
                <div class="modal-footer">
                    <a href="#!" class=" modal-action modal-close waves-effect waves-green btn-flat" onclick="somInstrumentos(); execucaoSomInstrumentos();">Ok!</a>
                </div>
            </center>
        </div>
        <div id="modal2" class="modal">
            <center>
                ...
                <div class="modal-footer">
                    <a href="#!" class=" modal-action modal-close waves-effect waves-green btn-flat" onclick="execucaoSomInstrumentos()">ok!</a>
                </div>
            </center>
        </div>
